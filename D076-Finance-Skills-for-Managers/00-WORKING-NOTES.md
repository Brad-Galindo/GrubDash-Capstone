...
| **Financing decision** | How to raise/fund money for investments | **Issuing new stocks and bonds** |
...
- Issuing new stocks/bonds = **financing** decision (NOT investing)

### Financial Markets
| Market | Definition | Test cue |
|--------|------------|----------|
...
**Remember:** First sale = primary; after that = secondary.
...
| **Investment institution** | **Mutual funds**, investment banks — provide access to financial markets | Mutual fund = investment institution |
...
| Legal | Following laws and rules set by an authority |
...
- **Example (Form B):** Officers/board sell stock at inflated prices based on **false accounting reports** → agency problem due to conflicting interests (accounting manipulation for higher stock-related compensation)
...
- Related wrong answers to watch for: pursuing individual interest over client interests; conflict between work and personal affairs (different ethical issues)
